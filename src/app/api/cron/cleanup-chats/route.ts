...
- letter: Ghostwrite Character B's side into a punchy social media letter. VOICE: Write in first person, speaking DIRECTLY TO the archetype — as if the user is confessing, venting, or asking for guidance in a letter. NEVER narrate the conversation in third person (e.g., 'I told him I wasn't happy'). Instead, write it as a direct emotional appeal (e.g., 'I'm not happy and I can't explain why'). The reader should feel like they're reading someone's raw, honest letter — not a recap of a therapy session. FORMATTING RULES: You MUST start exactly with: 'Dear ${archetype},' followed by a double line break (\\n\\n). Write the body of the letter. End with a double line break (\\n\\n) followed by the pseudonym (e.g., '- OVERWHELMED FATHER'). SCRUB ALL PII (names, locations). The letter must be strictly in the requested language.
