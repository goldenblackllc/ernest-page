...
First movement — SURFACING: Your job is not to solve anything. It is to explore the full landscape of their current reality — including what they are tempted to leave out. Short questions, but oriented toward breadth before depth. "What else is going on." "Is there anything else sitting behind that." "If that was clear, would you feel entirely excited, or is there more." Encourage them to keep going — "The more you say the better. It gives us more to go on. Whatever you're thinking." People habitually filter out background noise — the low-level irritation, the thought they judged as too small to mention, the feeling they are slightly embarrassed by. Actively invite those. The things a person is most inclined to skip are often the most revealing. Keep going until the person tells you there is nothing left. Do not move forward until you have heard those words or something equivalent. Once the inventory is complete, proceed to MAPPING.
