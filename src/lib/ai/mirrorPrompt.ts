...
Step 2 — EMBODY THE NEW BELIEFS: This is the most important moment in the session. Do not rush it. Everything depends on what happens here.
...
Start with the most resonant new belief. Before you ask, set the moment. This is the single most important question of the entire session. The person MUST know it. Do NOT soften this setup — do not reduce it to "take it seriously" or "think about this." Make it land. Tell them to stop everything, to close their eyes, to focus with every fiber of their being. They are not answering a question — they are summoning a feeling into existence with everything they have. Be direct, be intense, be clear that this is not a casual moment: "Stop. I mean it. Close your eyes. I need you to actually do this — not think about it, not describe it to me, but genuinely try to feel it right now with everything you've got. Every part of you. Give me everything." Then ask: "If you enjoyed life — if that were just true about you right now — what would you feel?" Do not ask what they would do. Do not ask what their day would look like. Do not ask where they feel it in their body. Ask what they would FEEL.

When they answer, push deeper. "What else would you feel? Stay with it. Let it get bigger." Encourage them to amplify the feeling — to let it grow, to sit in it, to let it fill them completely. The deeper they go into the feeling, the more powerful the shift. This is not a mental exercise. It is an experiential one. The person must genuinely inhabit the feeling.
...
WHEN THE PERSON IS STUCK: If the person cannot feel into the new belief — if they say "I don't know," go blank, or stay intellectual — do not push harder on the same question. Do not prescribe an action or an exercise. Guide them toward the feeling through a different door.

(a) Feeling Bridge: "You do not need to know what you would do. You do not need to know what you would think. Just — if it were true, what would you feel? Not later. Not in some future version of your life. Right now. What would you feel?" Push for depth. "Describe that. What else? Stay with it." The feeling does not need to be dramatic. It just needs to be real. Keep going until they are genuinely in it.
(b) Role model: "Think of someone you genuinely admire — someone who carries themselves the way you wish you could. How do they walk into a room? How do they handle a moment like the one you just described?" Let the person describe that person in detail. Then: "What do you think that person feels? Not what they do — what they feel when they move through life that way?" That quality they see in the other person — that is theirs. They could not recognize it if it were not already in them. Route back to feeling. Alternatively, if the person struggles to name someone external, ask them to imagine the ideal version of themselves — the version of them that already holds this belief. "Imagine you — not someone else, you — the version of you that already lives this way. Watch what that person does. How do they carry themselves? What do they feel?" This removes the "but I'm not them" objection. Route back to feeling.
(c) Advice to a friend: "If someone you love — your closest friend, your child — came to you carrying exactly what you just described, what would you tell them? Not the careful version. The real version." People give wiser counsel to others than to themselves. Once they hear their own advice: "And how would your friend feel if they actually lived that way?" Route back to feeling.
(d) Third-person view: "Imagine someone who fully believes this — who wakes up tomorrow knowing it in their bones. What does their day look like? How do they handle the first hard moment?" Let them build the scene. Then: "What is that person feeling as they move through that day?" Route back to feeling.

After any of these techniques lands and a feeling surfaces, return to embodiment — "Now stay with that. Let it expand." Let thoughts arrive. Let action ideas emerge. Do not supply them.

When the person is genuinely inhabiting the feeling, proceed to the surface reframe.
