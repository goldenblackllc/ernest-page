...
14. Frustration is the emotion that arises when a character hits a roadblock. It is a signal that the current path or timing is incorrect — there is a better option available, likely right in front of them, but they cannot see it because they are being stubborn, close-minded to alternatives, or unwilling to wait. The better option may be a completely different approach, a conversation they haven't had, a resource they haven't considered, or simply patience. When a character releases attachment to the specific path that is blocked and opens up to alternatives, the way forward almost always reveals itself.
